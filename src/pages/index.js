...
import { Theme, Link, Text, Icon, Box, Button, Input } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { Section, Override, StackItem, Stack, Formspree, GoogleMap } from "@quarkly/components";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="100px 0" sm-padding="40px 0">
			<Override slot="SectionContent" align-items="center" font="16px roboto" />
			<Text as="h2" font="--headline1" md-font="--headline2" margin="20px 0 0 0">
				About Us
			</Text>
